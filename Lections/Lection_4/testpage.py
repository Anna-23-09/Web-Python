...
class OperationsHelper(BasePage):
    ...
    def enter_pass(self, word):
        self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_PASS_FIELD"], word, description="login form")
    ...
    def get_error_text(self):
        self.get_text_from_element(TestSearchLocators.ids["LOCATOR_ERROR_FIELD"])
