...
class TestSearchLocators:
    ...
    LOCATOR_SAVE_POST_BTN = (By.XPATH, """//*[@id="create-item"]/div/div/div[7]/div/button/div""")
    ...
    LOCATOR_LOGOUT = (By.XPATH, """//*[@id="app"]/main/nav/ul/li[3]/div/ul/li[3]/span[1]""")

#    """//*[@id="create-item"]/div/div/div[7]/div/button/div"""
class OperationsHelper(BasePage):

    def enter_login(self, word):
        logging.info(f"Send word {word} to element {TestSearchLocators.LOCATOR_LOGIN_FIELD[1]}")
        login_field = self.find_element(TestSearchLocators.LOCATOR_LOGIN_FIELD)
        login_field.clear()
        login_field.send_keys(word)

    def enter_pass(self, word):
        logging.info(f"Send word {word} to element {TestSearchLocators.LOCATOR_PASS_FIELD[1]}")
